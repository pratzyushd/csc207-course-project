...
public class DisplayUserTagsInteractor implements DisplayUserTagsInputBoundary {
    ...
    private final DisplayUserTagsUserDataAccessInterface dataAccess;
     ...
     */
    public DisplayUserTagsInteractor(DisplayUserTagsOutputBoundary presenter, DisplayUserTagsUserDataAccessInterface dataAccess) {
